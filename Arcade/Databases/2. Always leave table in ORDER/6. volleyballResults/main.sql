 ...
 * the results of volleyball teams from all around the world. Your website regularly
 ...
 * should be sorted in ascending order by the total number of games won. This
 * year's results are quite marvelous - at any given moment there are no two teams
 * that have won the same number of games!
